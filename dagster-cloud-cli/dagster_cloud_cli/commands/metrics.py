...
def get_source() -> CliEventTags.source:
    ...
    env_map = {
        "BITBUCKET_BUILD_NUMBER": (
            CliEventTags.source.bitbucket
        ),  # https://support.atlassian.com/bitbucket-cloud/docs/variables-and-secrets/
        "BUILDKITE": (
            CliEventTags.source.buildkite
        ),  # https://buildkite.com/docs/pipelines/environment-variables
        "CIRCLECI": (
            CliEventTags.source.circle_ci
        ),  # https://circleci.com/docs/variables/#built-in-environment-variables
        "CODEBUILD_BUILD_ID": (
            CliEventTags.source.codebuild
        ),  # https://docs.aws.amazon.com/codebuild/latest/userguide/build-env-ref-env-vars.html
        "GITHUB_ACTION": (
            CliEventTags.source.github
        ),  # https://docs.github.com/en/actions/learn-github-actions/variables#default-environment-variables
        "GITLAB_CI": (
            CliEventTags.source.gitlab
        ),  # https://docs.gitlab.com/ee/ci/variables/predefined_variables.html
        "JENKINS_URL": (
            CliEventTags.source.jenkins
        ),  # https://www.jenkins.io/doc/book/pipeline/jenkinsfile/#using-environment-variables
        "TRAVIS": (
            CliEventTags.source.travis
